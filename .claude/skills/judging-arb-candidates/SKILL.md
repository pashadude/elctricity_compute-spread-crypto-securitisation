...
description: Principles for the 4-way classifier that gates every chain action. Use when reviewing or editing the judge layer, when a judgement looks wrong in retrospect, or when proposing policy changes via the self-improvement skill.
---
