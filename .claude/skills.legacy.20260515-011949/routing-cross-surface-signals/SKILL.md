...
description: Principles for surface_router.route() — how an arb signal becomes a ranked list of candidates across Polymarket / IBKR / Crypto / Kalshi. Use when reviewing routing decisions, when a surface produces consistent losers, or when proposing a new direction → instrument mapping.
---
