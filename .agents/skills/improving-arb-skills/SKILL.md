...
description: Use when editing .agents/skills, skill descriptions, references, self-improvement notes, or agent workflow docs. Enforces that skill changes must not weaken premium-gate, judge-gate, credential, or on-chain execution invariants. Do not use to modify trading logic directly.
---
...
open .agents/skills/*/SKILL.md, AGENTS.md, CLAUDE.md, .github/copilot-instructions.md if present
use only for skills/docs/workflow maintenance
do not modify trading logic directly
no skill edit may weaken premium gate, judge gate, credential handling, or on-chain execution rules
do not add triggers: as the primary routing mechanism
descriptions must carry trigger phrases
